<template>
  <v-container fluid class="pa-0">
    <v-row no-gutters>
      <!-- SIDEBAR -->
      <v-col cols="12" md="3" class="sidebar-elevated">
        <div class="pa-4 d-flex align-center">
          <div>
            <h2 class="font-weight-bold mb-0">iRecruit</h2>
            <div class="subtitle">Online Recruitment</div>
          </div>
        </div>
      ...
      <!-- MAIN CONTENT -->
      <v-col cols="12" md="9" class="pa-6 main-bg">
...
export default {
  ...
  data () {
    return {
      selectAll: false,
      menus: [
        { icon: 'mdi-clock-outline', title: 'ระบบลงเวลางาน', to: '/attendance', active: true },
        { icon: 'mdi-file-document-outline', title: 'ระบบขอเอกสาร', to: '/documents/request', active: false },
        { icon: 'mdi-airplane', title: 'ระบบลา', to: '/leave', active: false },
        { icon: 'mdi-calendar-clock', title: 'ระบบกะ', to: '/shift', active: false },
        { icon: 'mdi-hospital-box', title: 'ระบบเบิกค่ารักษา', to: '/claims/medical', active: false },
        { icon: 'mdi-clock-alert', title: 'ระบบเบิกค่าล่วงเวลา', to: '/claims/overtime', active: false },
        { icon: 'mdi-file-check', title: 'ระบบอนุมัติเอกสาร', to: '/documents/approval', active: false },
        { icon: 'mdi-account-lock', title: 'จัดการสิทธิการใช้งาน', to: '/access-control', active: false }
      ],
      breadcrumbs: [
